            ...
            <table border="0" width="480" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                    <td style="line-height:1;color:#3c3c3c;font-size:21px;font-weight:600;font-family:'Open Sans',Helvetica,sans-serif" align="left">
                        <div><span>Sayın {{$name}} Adlı Müşterimiz,</span></div>
                    </td>
                </tr>
                <tr>
                    <td height="30">&nbsp;</td>
                ...
                <tr>
                    <td style="line-height:1.8;color:#3c3c3c;font-size:16px;font-weight:400;font-family:'Open Sans',Helvetica,sans-serif" align="left">
                        <div><span><strong>{{$time}}</strong> tarihinde oluşturulan <strong>#{{$code}}00</strong> numaralı faturanız için yaptığınız ödeme onaylanmıştır. Ödemeniz ve bizi tercih ettiğiniz için teşekkür ederiz.</span></div>
                    </td>
                </tr>
                <tr>
                    <td height="25">&nbsp;</td>
...
------------------------------<wbr>------------------------<br>
                                Toplam Ürün Sayısı: {{$totalCount}}<br>
Ara Toplam: {{$totalPrice}}.00 TL<br>
0% KDV: {{$totalPrice}}.00 TL<br>
Kargo Fiyatı: 0.00 TL<br>
Toplam: {{$totalPrice}} TL</span></div>
                    </td>
                </tr>
                <tr>
                    <td height="25">&nbsp;</td>
                ...
                <tr>
                    <td style="line-height:1.8;color:#3c3c3c;font-size:16px;font-weight:400;font-family:'Open Sans',Helvetica,sans-serif" align="left">
                        <div><span> <strong>Tutar:</strong> {{$totalPrice}} TL<br><strong>İşlem Numarası:</strong> #329350<br><strong>Toplam Ödenen Tutar:</strong> {{$totalPrice}} TL<br><strong>Kalan Ödeme Tutarı:</strong> 0.00 TL<br><strong>Sipariş Durumu:</strong> Tedarik Ediliyor.<br></span></div>
                    </td>
                </tr>
                <tr>
                    <td height="25">&nbsp;</td>
