...
@section('content')
    ...
    <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Kategori Ekleme Sayfası</h4>
                ...
                <form method="POST" action="{{route('admin.newCategoryPost')}}" class="forms-sample">
                    @CSRF
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="order"  id="exampleInputUsername1">
                    </div>
                    <button type="submit" class="btn btn-primary me-2">Yeni Ekle</button>
